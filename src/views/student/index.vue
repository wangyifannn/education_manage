...
export default {
  ...
  methods: {
    ...
    // 获取数据
    getData(params, obj, type) {
      var _this = this;
      var config = {
        roleid: !!params && !!params.roleid ? params.roleid : "",
        teacherid: "",
        classesId: !!params && !!params.classesId ? params.classesId : "",
        loginName: "",
        userName: "",
        ...
        size: !!params && !!params.size ? params.size : _this.pageSize
      };
      if (type !== "form") {
        // 添加查询字段
        ...
        .then(res => {
          ...
          if (!!res && res.code === 20000) {
            for (var i = 0; i < res.data.rows.length; i++) {
              ...
              res.data.rows[i].userStatus =
                res.data.rows[i].openid === null ? "未绑定" : "已绑定";
